"""
Django settings for sample_wagtail project.
...
ROOT_URLCONF = "sample_wagtail.urls"
...
WSGI_APPLICATION = "sample_wagtail.wsgi.application"
...
WAGTAIL_SITE_NAME = "sample_wagtail"
...
BASE_URL = os.getenv("DOMAIN", "http://sample_wagtail.caktus-built.com")
...
ADMINS = os.getenv(
    ...
    [
        (
            "caktus-sample_wagtail-team",
            "sample_wagtail-team@caktusgroup.com",
        )
    ],
)
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "no-reply@sample_wagtail.caktus-built.com")
