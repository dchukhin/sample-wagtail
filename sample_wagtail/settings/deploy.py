...
from sample_wagtail.settings.base import *  # noqa: F403
...
EMAIL_SUBJECT_PREFIX = "[sample_wagtail %s] " % ENVIRONMENT.title()
...
### ADMINS and MANAGERS
ADMINS = (("sample-wagtail Dev Team", "sample_wagtail-team@caktusgroup.com"),)
