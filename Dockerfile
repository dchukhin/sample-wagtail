...
COPY --from=static_files /code/sample_wagtail/static /code/sample_wagtail/static
...
ENV DJANGO_SETTINGS_MODULE=sample_wagtail.settings.deploy
...
ENV UWSGI_WSGI_FILE=sample_wagtail/wsgi.py
